...
function s(e) {
    var t = [];
    if (0 == n.length || !o) return (d = {}).node = "text", d.text = e, s = [ d ];
    e = e.replace(/\[([^\[\]]+)\]/g, ":$1:");
...
var n = "", a = "", o = {}, i = require("./wxDiscode.js"), l = require("./htmlparser.js"), d = (e("area,base,basefont,br,col,frame,hr,img,input,link,meta,param,embed,command,keygen,source,track,wbr"), 
...
module.exports = {
    html2json: function(e, n) {
        console.log("html2json"), e = r(e = t(e)), e = i.strDiscode(e);
        var a = [], o = {
            node: n,
            nodes: [],
            images: [],
        ...
        return l(e, {
            start: function(e, t, r) {
                ...
                if (0 === a.length ? (s.index = p.toString(), p += 1) : (void 0 === (v = a[0]).nodes && (v.nodes = []), 
                ...
                0 !== t.length && (s.attr = t.reduce(function(e, t) {
                    ...
                    return "class" == r && (s.classStr = n), "style" == r && (s.styleStr = n), n.match(/ /) && (n = n.split(" ")), 
                    e[r] ? Array.isArray(e[r]) ? e[r].push(n) : e[r] = [ e[r], n ] : e[r] = n, e;
                }, {})), "img" === s.tag) {
                    s.imgIndex = o.images.length;
                    var l = s.attr.src;
                    "" == l[0] && l.splice(0, 1), l = i.strDiscode(l), s.attr.src = l, s.from = n, o.images.push(s), 
                    o.imageUrls.push(l);
                }
                if ("font" === s.tag) {
                ...
                delete o.source), 0 === a.length) o.nodes.push(t); else {
                    var r = a[0];
            ...
            chars: function(e) {
                ...
                if (0 === a.length) t.index = p.toString(), p += 1, o.nodes.push(t); else {
                    var r = a[0];
